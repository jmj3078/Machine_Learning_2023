...
# Transfer learning, resnet50사용
resnet_model = keras.applications.resnet_v2.ResNet50V2(weights='imagenet', include_top=False, input_shape=(75, 75, 3))
...
result.to_csv("predict_resnet50.csv", index=False)
